...
var chartBarColors = getChartColorsArray("simple_pie_chart"), options = {
...
}, upadatedonutchart = new ApexCharts(document.querySelector("#updating_donut_chart"), options);
...
upadatedonutchart.render(), document.querySelector("#randomize").addEventListener("click", function () {
...
options = {
    ...
    stroke: {width: 0},
    plotOptions: {pie: {donut: {labels: {show: !0, total: {showAlways: !0, show: !0}}}}},
...
(chart = new ApexCharts(document.querySelector("#monochrome_pie_chart"), options)).render();