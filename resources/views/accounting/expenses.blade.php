            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="simple_pie_chart_day" data-colors='["--bs-primary", "--bs-success", "--bs-warning", "--bs-danger", "--bs-info"]'  class="apex-charts" dir="ltr"></div>
                        </div>
                    </div><!--end card-->
                </div><!-- end col -->
                <div class="col-lg-4">
                                ...
                                <table class="table align-middle table-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-success font-size-12"><i
                                                        class="mdi mdi-star me-1"></i> 4.2</span></td>
                                        <td>$5,412</td>
                                        <td>07 Oct, 2019</td>
                                        <td>
                                            <div class="dropdown">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-success font-size-12"><i
                                                        class="mdi mdi-star me-1"></i> 4.0</span></td>
                                        <td>$5,632</td>
                                        <td>06 Oct, 2019</td>
                                        <td>
                                            <div class="dropdown">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-success font-size-12"><i
                                                        class="mdi mdi-star me-1"></i> 4.4</span></td>
                                        <td>$7,523</td>
                                        <td>06 Oct, 2019</td>
                                        <td>
                                            <div class="dropdown">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-success font-size-12"><i
                                                        class="mdi mdi-star me-1"></i> 3.8</span></td>
                                        <td>$4,523</td>
                                        <td>04 Oct, 2019</td>
                                        <td>
                                            <div class="dropdown">
