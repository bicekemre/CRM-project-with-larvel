                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" value="{{ $refund->amount }}" name="amount">
                                            @error('amount')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone-mask" value="{{ $refund->installment }}" name="installment">
                                            @error('installment')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="email-input" value="{{ $refund->desc }}" name="desc">
                                            @error('desc')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="id_client" class="form-select">
                                                @isset($revenue->id_client)<option selected value="{{ $refund->client->id }}">{{ $refund->client->name }}</option>@endisset
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="id_service" class="form-select">
                                                @isset($revenue->id_service)<option selected value="{{ $refund->service->id }}">{{ $refund->service->name }}</option>@endisset
                                            </select>
                                        </div>
